...
**Project**: particle-palette-generator 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: a particle generator. 
- shows tweakable parameters in a column to the left: number of particles, speed, type of movement, particle shape, color
- shows the result to the right, taking as much space as possible in the screen 
...
```sh
git clone https://github.com/GPT-Engineer-App/particle-palette-generator.git
cd particle-palette-generator
npm i
